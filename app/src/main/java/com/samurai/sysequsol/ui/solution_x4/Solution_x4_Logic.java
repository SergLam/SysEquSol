...
public class Solution_x4_Logic {
    ...
    public void setDet1_arr() {
        this.det1_arr = gm.set_det(this.src_arr, 0, 4);
    }
    ...
    public void setDet2_arr() {
        this.det2_arr = gm.set_det(this.src_arr, 1, 4);
    }
    ...
    public void setDet3_arr() {
        this.det3_arr = gm.set_det(this.src_arr, 2, 4);
    }
    ...
    public void setDet4_arr() {
        this.det4_arr = gm.set_det(this.src_arr, 3, 4);
    }
    ...
    public void setDet2_val() {this.det2_val = gm.calc_det_val(det2_arr);}
