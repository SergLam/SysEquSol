...
public class Solution_x6_Logic {
    ...
    private double det6_val;


    Solution_x6_Logic(double[][] arr) {
        calc_det(arr);
    }
    ...
    public void setDet1_arr() {
        this.det1_arr = gm.set_det(this.src_arr, 0, 6);
    }
    ...
    public void setDet2_arr() {
        this.det2_arr = gm.set_det(this.src_arr, 1, 6);
    }
    ...
    public void setDet3_arr() {
        this.det3_arr = gm.set_det(this.src_arr, 2, 6);
    }
    ...
    public void setDet4_arr() {
        this.det4_arr = gm.set_det(this.src_arr, 3, 6);
    }
    ...
    public void setDet5_arr() {
        this.det5_arr = gm.set_det(this.src_arr, 4, 6);
    }
    ...
    public void setDet6_arr() {
        this.det6_arr = gm.set_det(this.src_arr, 5, 6);
    }

    public double[][] getDet6_arr() {
        return det6_arr;
    }
    ...
    public void setDet5_val() {this.det5_val = gm.calc_det_val(det5_arr);}

    public double getDet5_val() {
        return det5_val;
    }

    public void setDet6_val() {this.det6_val = gm.calc_det_val(det6_arr);}

    public double getDet6_val() {
        return det6_val;
    }
